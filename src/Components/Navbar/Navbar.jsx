...
const Navbar = () => {
  ...
  return (
    <>
    <Box width={["100%", "100%", "100", "100%"]} bg="white" top={"0"} className="navbarbox">
      <Flex
        width={["90%", "90%", "90%", "90%"]}
        position="fix"
      ...
      >
        ...
        >
          ...
          <Button fontSize={["sm", "sm", "md", "md"]}>Supper Center</Button>
